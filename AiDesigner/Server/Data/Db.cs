...
namespace AiDesigner.Server.Data
{
    public class DBConnection
    {
        ...
        {
            StringBuilder query = new StringBuilder(@"SELECT COUNT(*) FROM nestor.Workshop_Article a WHERE 1=1");
        ...
        {
            var query = @"
            INSERT INTO nestor.Workshop_Article (Id, Name, Description, SearchClass, AuthorId, AuthorName, ProgramId, ApiKey, ProgramImage, Type, Created, Downloads)
