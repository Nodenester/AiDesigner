...
namespace AiDesigner.Server.Data
{
    public class DBConnection
    {
        ...
        public async Task<Guid> SaveProgramAsync(ProgramObject programObject)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    var query = @"
                        INSERT INTO nestor.programs (Id, Name, Description, Author, AuthorName, ApiKey, IsCustomBlock, IsPublic, ProgramData, SupportsSessions, Image)
        ...
        {
            string query = @"SELECT TOP 10 * FROM nestor.News_Article 
